...
- Run any command against it from Windows: `wsl.exe -d Ubuntu-24.04 -- bash -lc 'source ~/miniconda3/etc/profile.d/conda.sh && conda activate tf && cd /home/brais/code/DL-Forecasting && <command>'`.
