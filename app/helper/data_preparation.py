...
def to_timeframe(
    ...
    def round_single_datetime(dt: datetime | Timestamp):
        """
...
def times_in_date_range(
    date_range_str: str, timeframe: str, ignore_out_of_process_period: bool = True, processing_date_range: str = None
) -> DatetimeIndex:
    start, end = date_range(date_range_str)
