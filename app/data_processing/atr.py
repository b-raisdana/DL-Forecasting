...
from app.data_processing.disk_cache import cache_on_disk
from app.data_processing.ohlcv import cache_times, get_multi_timeframe_ohlcv
from app.helper.data_preparation import (
    concat,
    empty_df,
    expand_date_range,
...
@cache_on_disk(file_name_prefix="multi_timeframe_ohlcva", after_read=cache_times)
...
@cache_on_disk(file_name_prefix="multi_timeframe_ohlcva", after_read=cache_times)
def core_get_multi_timeframe_ohlcva(date_range_str: str = None) -> pt.DataFrame[MultiTimeframeOHLCVA]:
    if date_range_str is None:
        date_range_str = app_config.processing_date_range
...
def read_daily_multi_timeframe_ohlcva(day: datetime, timezone="GMT") -> pt.DataFrame[MultiTimeframeOHLCVA]:
    ...
    return core_get_multi_timeframe_ohlcva(day_date_range_str)
