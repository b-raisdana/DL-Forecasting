...
`application.model_implementations.tier1_000.train.run_training()` and renders its calling points
...
`application/model_implementations/<design_set>/` module — e.g. a future Tier-1_001 gets
`presentation/model_implementations/tier1_001_training.py`, not a shared abstraction guessed at ahead
