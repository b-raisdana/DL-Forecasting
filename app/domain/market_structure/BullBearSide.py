...
from domain.schemas.market_structure.BullBearSide import BullBearSide, MultiTimeframeBullBearSide, bull_bear_side_repr
from domain.schemas.market_structure.CandleTrend import CandleTrend, MultiTimeframeCandleTrend
