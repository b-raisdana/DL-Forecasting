...
from application.model_implementations.cnn_lstm_attention.cnn_lstm_attention_model import build_cnn_lstm_attention_model
...
input_shapes = {"structure": (96, 5), "pattern": (168, 5), "trigger": (672, 5), "double": (100, 5)}
...
def run_ga(toolbox, pop_size=6, generations=5):
    ...
    pop, log = algorithms.eaSimple(
        pop, toolbox, cxpb=0.5, mutpb=0.3, ngen=generations, stats=stats, halloffame=hof, verbose=True
    )
