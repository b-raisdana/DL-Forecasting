...
def major_times_tops_pivots(date_range_str) -> pt.DataFrame[MultiTimeframePivotDFM]:
    ...
    """
    _multi_timeframe_peaks_n_valleys = get_multi_timeframe_peaks_n_valleys(date_range_str)
    _multi_timeframe_ohlcva = get_multi_timeframe_ohlcva(date_range_str)
    ...
    for timeframe in app_config.structure_timeframes[::-1][2:]:
        ...
        _pivots = pivots_level_n_margins(
            timeframe_pivots=_pivots,
            pivot_time_peaks_n_valleys=_pivots,
            timeframe=timeframe,
