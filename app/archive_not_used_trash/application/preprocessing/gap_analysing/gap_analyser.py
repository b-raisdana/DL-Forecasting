...
def single_timeframe_find_gap(
    ohlcv: pt.DataFrame[OHLCV], timeframe, mode: Literal["count", "list", "boolean"] = "boolean"
):
    ...
    full_date_range = pd.date_range(
        start=ohlcv_sorted.index.min(), end=ohlcv_sorted.index.max(), freq=timeframe, tz=ohlcv_sorted.index.tz
    )
